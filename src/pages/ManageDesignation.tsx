    ...
    return (
      ...
      <QuotesComp></QuotesComp> */}
            <div>
                <div>
                    <Card>
                    <DataTable value={designationsdata} showGridlines={false} responsiveLayout="scroll" paginator={true} rowsPerPageOptions={[10,20,50]} rows={10} globalFilterFields={["DesignationName", "DesignationDesc", "Active"]} filters={filters2} header={Headercomp}>
