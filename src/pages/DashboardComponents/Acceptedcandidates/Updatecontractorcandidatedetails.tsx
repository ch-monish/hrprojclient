...
import { updatecontractcandidateaction } from "../../../features/Acceptedcandidates/contractselectedcanslice";
...
function Updatecontractorcandidatedetails(props) {
                        ...
                        <Form
                            onSubmit={(values) => {
                                ...
                                updateacceptedcandidatesapis
                                    .updatecontractcandidate(values)
                                    .then((res) => {
                                        console.log(res);
                                ...
                                //   dispatch(updatecontractcandidateaction(values));
                                //   navigate(-1);
                            }}
                                            ...
                                            <Field name="OfficialMailId">
                                                {({ input, meta }) => (
                                                    <div className="field fluid">
                                                        ...
                                                        <span className="field fluid">
                                                            <input className="p-inputtext p-component" {...input} maxLength={50} type="email" placeholder="Enter Official Email"></input>
                                                        </span>
                                                        {getFormErrorMessage(meta)}
                                                    </div>
                                                )}
                                    ...
                                    <div className="p-fluid grid mb-1 mt-1">
                                        <div className="field col-12 md:col-4">
                                            <Field name="IsJoined" type="checkbox">
                                                {({ input, meta }) => (
                                                    <div className="field fluid">
                                                        <label className="mr-3 mt-1">Is Joined ?</label>
                                                        <span className="field fluid">
...
export default connect(mapStateToProps)(Updatecontractorcandidatedetails);
